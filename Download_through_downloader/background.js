...
if (typeof browser !== 'undefined') {
	...
	function osm_piskvor_org_share(e) {
		...
		browser.tabs.executeScript({
			...
			";var notyf=notyf_setup_inpage(); xhr_call_inpage('" + loadUrl + "',function(e){xhr_call_inpage_result(e, notyf, '" + url + "'," + JSON.stringify(texts) + ")})}();" /* ...and call them */
		});
	}
