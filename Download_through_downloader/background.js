...
function xhr_call_inpage(url, loadend) {
...
function osm_piskvor_org_share(e) {
	...
	const downloaderUrl = "https://dl.piskvor.org/downloader/?do=add&isScript=1";
